			...
			- **StringBuilder**
				...
				- *表2-13 StringBuilder类的常用属性、方法及说明*
					- 属　性
					  ...
					  添加特定格式的字符串
					  Insert()
					  将字符串或对象添加到当前StringBuilder对象中的指定位置上
					  Remove()
					  从当前StringBuilder对象中移除指定范围的字符
					  Replace()
					  将StringBuilder对象内的特定字符用另一个指定的字符来替换
					  ToString()
					  将StringBuilder类对象转换为String类对象
-
-
-
-
